...
dat = select(raw_data,exp_time_hrs,dth_flag,sex,religion,occupation,social_status,allegiance_last,allegiance_switched,prominence)
dat = mutate(dat,
...
```{r}
Model_Full = coxph(Surv(exp_time_hrs,dth_flag)~.,data=dat)
